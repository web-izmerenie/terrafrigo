...
$APPLICATION->SetPageProperty("title", "Купить рефрижератор в Москве, Ростове-на-Дону, Нижнем Новгороде. Холодильный рефрижератор на ГАЗ (Газель), Hyundai, Мерседес, Форд, Ман");
