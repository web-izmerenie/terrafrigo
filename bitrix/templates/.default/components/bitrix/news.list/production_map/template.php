...
<?if(!empty($arResult['ITEMS'])){?>
    <div class="production-map">
        <img src="/bitrix/templates/main/img/map-big2.png" alt="" class="width-all" />
        <div class="production-map-inr">
            <?foreach($arResult['ITEMS'] as $arItem){
            $photo = CFile::ResizeImageGet($arItem['PREVIEW_PICTURE'], array('width'=>565, 'height'=>133), BX_RESIZE_IMAGE_EXACT, true);   
            ?>
