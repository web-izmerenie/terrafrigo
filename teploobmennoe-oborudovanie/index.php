...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "heat_transfer_equipment_is", Array(
...
<div class="benefit-block">
    <ul>
        ...
        <li class="benefit-icon-7" style="background-color: #21c097;"><span>Фреон, заправляемый в установки, не содержит хлора и безопасен для окружающей среды и перевозимой продукции</span></li>
    </ul>
</div>
